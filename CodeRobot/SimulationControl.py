...
class SimulationControl:
    def __init__(self, N,temps_fin,tps_ellipse):
        ...
        #self.points = [[-4.472188,48.418527],[-4.472531,48.418554],[-4.472500,48.418601],[-4.472275,48.418520]]
        #self.objectifs=[[-4.472188,48.418527],[-4.472531,48.418554],[-4.472500,48.418601],[-4.472275,48.418520]]
        self.points = [[0,0],[40.863285863772035, 4.2179290521889925],[37.32119551504729, 39.42228888720274],[-3.5161916106007993, 36.53818473871797]]
        self.objectifs = [[20.0,30.0],[20.01,10.0]]
        #self.objectifs = [[0,0],[40.863285863772035, 4.2179290521889925],[37.32119551504729, 39.42228888720274],[-3.5161916106007993, 36.53818473871797]]
    ...
    def simuOneStep(self,t,k,tk,theta_i,theta_f,l_i,l_f,centre_i,centre_f,X):
        ...
        D = np.array([[ mAxis ,0],[0,mAxis*0.1]])
        ...
        if(k==0 and tk > self.tps_ellipse): # permanent regime, ellipse is not moving
        ...
        return t,k,tk,theta_i,theta_f,l_i,l_f,centre_i,centre_f, toSend, X, cons,dcons
